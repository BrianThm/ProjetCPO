...
public class ControllerTest extends SetupTest {
	...
	public void testAddTournament() {
		...
		assertEquals("The tournament has not been correctly add in the controller",tournaments,controller.getTournaments());
	...
	public void testGetNbPlayers() throws PlayerAlreadyExistsException {
		assertEquals("The number of Players for controller is not good !", 4, controller.getNbPlayers());
		...
		assertEquals("The number of players for controller is not good !", 3, controller.getNbPlayers());
	...
	public void testGetNbTeams() throws TeamAlreadyExistsException {
		...
		controller.removeTeam(team);
		controller1.addTeam(team1);
		assertEquals("The number of teams for controller is not good !", 2, controller.getNbTeams());
